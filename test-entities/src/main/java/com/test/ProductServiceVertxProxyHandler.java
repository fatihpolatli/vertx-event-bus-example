  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "addProduct": {
          service.addProduct(json.getJsonObject("product") == null ? null : new com.test.entities.Product(json.getJsonObject("product")),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "updateProduct": {
          service.updateProduct(json.getJsonObject("product") == null ? null : new com.test.entities.Product(json.getJsonObject("product")),
                        HelperUtils.createHandler(msg));
          break;
        }
